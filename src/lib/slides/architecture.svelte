<script lang="ts">
	...
	const technologies: [string, Component][] = [
		['Компонентная иерархия', IconComponent],
		['Слоистая архитектура', ArrowUpNarrowWide],
		['Управление состоянием', Atom],
		['Хеш-роутинг', Hash],
		['Синхронизация данных', FolderSync]
	]
</script>
...
<Slide transition="fade" class="h-full p-10">
	<div class="flex h-full flex-col">
		<p class="pb-10">Архитектура и реализация пользовательского интерфейса</p>
...
<Slide transition="fade" class="h-full p-10">
	<div class="flex h-full flex-col">
		...
		<div class="max-h-[70vh] object-contain">
			{@render illustration(NetworkScreenshot, 'Страница «Панель настройки / Сеть»')}
		</div>
	</div>
</Slide>
